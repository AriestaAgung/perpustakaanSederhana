...
$query = "INSERT INTO peminjaman(nama_buku, nama_peminjam, tanggal_pinjam, tanggal_kembali) VALUES()";
?>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <!--                Sidebar-->
                <li><a href="index.php"><i class="fa fa-book"></i> <span>Data Peminjaman</span></a></li>

                <li class="active"><a href="inputpeminjaman.php"><i class="fa fa-edit"></i> <span>Input Peminjaman</span></a></li>
                        ...
                        <div class="box-body">
                            <form action="tambahpinjaman.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama-buku" name="namabuku" required placeholder="Nama Buku">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="datepicker" required placeholder="dd-mm-yyyy" name="tanggalkembali">
                                    <!-- /.input group -->
                                </div>
